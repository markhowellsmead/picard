	...
	public function run()
	{
		$this->loadClasses(
			[
				...
				\SayHello\Theme\Block\PhotosByAlbum::class,
				\SayHello\Theme\Block\PhotosByCollection::class,
				\SayHello\Theme\Block\PhotosByPlace::class,
				\SayHello\Theme\Block\PlaceAncestors::class,
				\SayHello\Theme\Block\PlaceCards::class,
				\SayHello\Theme\Block\PlaceDescendants::class,
