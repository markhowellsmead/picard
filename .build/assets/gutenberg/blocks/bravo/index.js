					...
					<div className={`${classNameBase}__inner`}>
						<div className={`${classNameBase}__content`}>
							<header className={`${classNameBase}__header`}>
								<BlockTitle className={`${classNameBase}__title`} title={attributes.title} setAttributes={setAttributes} />
							</header>
							<RichText
								tagName='div'
						...
						<LazyImageSelector attributes={attributes} className={`${classNameBase}__figure`} image={attributes.image} setAttributes={setAttributes} />
					</div>
				</section>,
			];
		}
			...
			<section className={className}>
				<div className={`${classNameBase}__inner`}>
					<div className={`${classNameBase}__content`}>
						...
						{!!attributes.text && attributes.text !== '<p></p>' && <RichText.Content tagName='div' className={`${classNameBase}__text`} value={attributes.text} />}
					</div>
					{attributes.image && attributes.image.id && <LazyImage className={`${classNameBase}__figure`} image={attributes.image} background={false} admin={false} />}
				</div>
			</section>
		);
	},
