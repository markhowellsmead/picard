...
export class LazyImage extends Component {
	...
	render() {
		...
		if (this.props.admin) {
			return (
				<figure className={className} style={style_orig}>
					<img {...image.attributes} className='o-lazyimage__image o-lazyimage__image--lazyloaded' src={image.org[0]} srcset={srcset} style={style_orig} />
				</figure>
			);
		}
		...
		return (
			<figure className={className} style={style_orig}>
				{!image.svg && <img className='o-lazyimage__preview' src={image.pre} style={style_pre} />}
				<img {...image.attributes} className='o-lazyimage__image o-lazyimage__image--lazyload' data-sizes='auto' src={image.pre} data-srcset={srcset} style={style_orig} />
				<noscript>
					<img {...image.attributes} className='o-lazyimage__image' src={image.org[0]} srcset={srcset} style={style_orig} />
				</noscript>
			</figure>
		);
	}
