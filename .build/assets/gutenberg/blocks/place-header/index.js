...
registerBlockType('mhm/place-header', {
    title: _x('Place header', 'Block title', 'sha'),
    icon: 'layout',
    category: 'widgets',
    ...
    edit,
    save({ attributes }) {
        let className = getBlockDefaultClassName('mhm/place-header');
        const classNameBase = getBlockDefaultClassName('mhm/place-header');
