...
registerBlockType( "mhm/language-excerpt", {
	title: _x( "Language excerpt", "Block title", "picard" ),
	description: _x( "This block allows the provision of a text excerpt in an alternative language.", "Block instructions", "picard" ),
	icon: "excerpt-view",
	category: "widgets",
	supports: {
		mode: false,
