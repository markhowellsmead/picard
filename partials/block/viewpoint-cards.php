			...
			<ul class="c-cardgrid__entries wp-block-mhm-blog-cards__entries">
				<?php foreach ($data['posts'] as $data_post) {
					if (has_post_thumbnail($data_post)) {
						$thumbnail = '<a class="c-cardgrid__figurelink wp-block-mhm-blog-cards__figurelink" href="' . get_permalink($data_post->ID) . '"><figure class="c-cardgrid__figure wp-block-mhm-blog-cards__figure">' . wp_get_attachment_image(get_post_thumbnail_id($page->ID), 'card', false, ['class' => 'wp-block-mhm-blog-cards__image']) . '</figure></a>';
