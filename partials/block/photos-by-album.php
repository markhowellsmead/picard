			...
			?>
				<div class="wp-block-photos-by-album__entry c-grid500__item" style="flex-grow:<?php echo $flex_grow; ?>;flex-basis:<?php echo $flex_basis; ?>px;">
					<?php if (!$data['is_preview']) { ?>
						<a class="c-grid500__itemlink" href="<?php echo $href; ?>" title="<?php echo get_the_title($album_post); ?>" data-fancybox="photos-by-place" data-caption="<?php echo get_the_title($album_post); ?>" data-type="image" data-srcset="<?php echo $fancybox_href; ?>">
