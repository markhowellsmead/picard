...
?><div class="c-searchform">
	<form role="search" aria-label="searchform-regular" method="get" class="search-form" action="<?php echo esc_url(home_url('/'));?>">
		<label class="c-searchform__label">
			...
			<input type="search" class="c-searchform__searchfield" placeholder="<?php _ex('Enter a search term', 'Default placeholder text', 'sht');?>" value="<?php echo get_search_query();?>" name="s"></label>
